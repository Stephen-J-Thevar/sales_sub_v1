...
function Filters() {
  ...
  // const [dftStartDate, setDftStartDate] = useState();
  // const [dftEndDate, setDftEndDate] = useState();

  const [clicked, setClicked] = useState(1);

  // const [calSelectedStartDate, setCalSelectedStartDate] = useState(null);
  // const [calSelectedEndDate, setCalSelectedEndDate] = useState(null);
  ...
  async function handleSearch() {
    let userSelectedFilter = {
      data: {
        date_filter: {
          start_date: calSelectedStartDate || "",
          end_date: calSelectedEndDate || "",
        },
  ...
  const handleRefresh = () => {
    ...
    setDftStartDate(() => new Date(start_date));
    setDftEndDate(() => new Date(end_date));
    setCalSelectedStartDate(null);
    setCalSelectedEndDate(null);
  };
  ...
  const handleDateSelect = useCallback(
    (dates) => {
      ...
      // setDftStartDate(() => new Date(selectedStartDate));
      // setDftEndDate(() => new Date(selectedEndDate));

      // setCalSelectedStartDate(selectedStartDate);
      // setCalSelectedEndDate(selectedEndDate);
    },
    [
      // setDftEndDate,
      // setDftStartDate,
      // setCalSelectedEndDate,
      // setCalSelectedStartDate,
    ]
  );
